...
It took lots of work for [my creator](t.me/mdiskmovies30) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [PayPal](t.me/mdiskmovies30), or [Monzo](t.me/mdiskmovies30)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="📢 𝕁𝕠𝕚𝕟 𝕆𝕦𝕣 𝕄𝕒𝕚𝕟 ℂ𝕙𝕒𝕟𝕟𝕖𝕝 📢", url="https://t.me/mdiskmovies30")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/likemoviesearch"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/likemovie30")],
                     [InlineKeyboardButton(text="𝕄𝕆𝕍𝕀𝔼𝕊 ℂℍ𝔸ℕℕ𝔼𝕃", url="https://t.me/mdiskmovies30"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
